...
class LogMF(GeneralRecommender):
    ...
    def __init__(self, config, dataset):
        ...
        self.model = implicit.lmf.LogisticMatrixFactorization(
            factors=embedding_size, learning_rate=lr, regularization=reg_weight, iterations=iterations, neg_prop=neg_prop, random_state=seed)
