...
class BPRImpl(GeneralRecommender):
    ...
    def __init__(self, config, dataset):
        ...
        verify_negative = config['verify_negative']
        seed = config['seed']

        self.model = implicit.bpr.BayesianPersonalizedRanking(
            factors=embedding_size, learning_rate=lr, regularization=reg_weight, iterations=iterations, verify_negative_samples=verify_negative, random_state=seed)
